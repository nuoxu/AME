...
from rlsearcher import TuneAME
...
def main():
    ...
    config = {
        ...
        "lr": tune.choice([0.001, 0.005, 0.010, 0.015, 0.020, 0.025, 0.030, 0.035, 0.040, 0.045, 
                           0.050, 0.055, 0.060, 0.065, 0.070, 0.075, 0.080, 0.085, 0.090, 0.095, 0.100]),
        "type": tune.choice(['SGD', 'Adadelta', 'Adagrad', 'Adam', 'Adamax']),
        "weight_decay": tune.choice([0.00000, 0.00001, 0.00005, 0.00010, 0.00015, 0.00020, 0.00025, 0.00030, 0.00035, 0.00040, 0.00045, 
                                     0.00050, 0.00055, 0.00060, 0.00065, 0.00070, 0.00075, 0.00080, 0.00085, 0.00090, 0.00095, 0.00100]),
        "batch_size": tune.choice([8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64])
    }
    ...
    np.save(osp.join(work_dir, 'ame_results.npy'), result_dict)
    searcher.save(osp.join(work_dir, 'ame_searcher.pkl'))
