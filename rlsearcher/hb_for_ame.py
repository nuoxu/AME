...
class HyperBandForAME(HyperBandScheduler):
    """Extends HyperBand early stopping algorithm for AME.
    ...
    AME to insert new trials into the training.
    ...
    def on_trial_add(self, trial_runner: "trial_runner.TrialRunner",
        ...
        if cur_bracket is None or cur_bracket.filled():
            ...
            while retry:
                ...
                if self._get_r0(s) == 0:
                    logger.debug("AME: Bracket too small - Retrying...")
                    cur_bracket = None
                else:
                    retry = False
